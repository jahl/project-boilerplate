...
render () {
    ...
    return (
        ...
        <div className="col-12">
            <div className="col-12">                        
              <h5 className="my-5 text-dark text-center display-4 font-weight-bold">Contact</h5>
            </div>
        </div>
            ...
            <div className="col-12">
                <form id="contact-form" className="form" action="#" method="POST" role="form">
                    ...
                    <div className="text-center">
                        <button type="submit" className="btn  btn-outline-warning my-4 py-3 h-100 btn-lg">Send Message</button>
                    </div>
                </form>
            </div>
        </div>
