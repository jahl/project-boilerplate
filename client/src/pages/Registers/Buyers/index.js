    ...
    return (
      <div className="container   w-100 my-md-3 pl-md-3">
        ...
        <div>
          ...
          <p className="text-center"> Fill all the information below.</p>
          <br />
        </div>
        ...
        <form className="form-signin" id="formSignUp" method="POST">
          ...
          <button className="btn b btn-secondary btn-block" type="submit">
            Sign Up
          </button>

          <a>
            {" "}
            By creating an account, you agree to out Agreement and Privacy
            Policy.
          </a>
