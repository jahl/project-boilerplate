        ...
        return (
            ...
            <div className="container  w-50 my-md-5 pl-md-5 my-5">
                ...
                <form className="form-signin" id="formSignUp" method="POST" >
                    <h5 className="text-dark text-center display-4 font-weight-bold mb-3">Log In</h5>
                    <br />
                    ...
                    <div className="text-center">
                        <a className="small text-secondary"> Don't have an account yet? <Link className="text-secondary" to="/register"> Register</Link> </a>
                    </div>
