...
render () {
    ...
    return (
        ...
        <div className="col-12">
            <div className="col-12">                        
              <h2 className="my-5 text-dark text-center display-4 font-weight-bold">Login</h2>
            </div>
        </div>
        <div className="col-12 py-5">
            <div className="col-8">
                <form id="contact-form" className="form" action="#" method="POST" role="form">
                    ...
                    <div className="form-group">
                        <input type="text" className="form-control" id="subject" name="subject" placeholder="Password" tabindex="3"/>
                    </div>                            
